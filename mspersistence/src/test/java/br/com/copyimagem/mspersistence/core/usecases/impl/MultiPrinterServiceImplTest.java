...
class MultiPrinterServiceImplTest {
    ...
    void shouldReturnMultiPrinterById() {
        ...
        when( convertObjectToObjectDTOService.convertToEntityOrDTO( multiPrinter, MultiPrinterDTO.class ) )
    ...
    void shouldReturnAListOfMultiPrinter() {
        ...
        when( convertObjectToObjectDTOService.convertEntityAndDTOList( List.of( multiPrinter ), MultiPrinterDTO.class ) )
    ...
    void shouldSaveAMultiPrinter() {
        ...
        when( convertObjectToObjectDTOService.convertToEntityOrDTO( multiPrinterDTO, MultiPrinter.class ) )
                                                                                         .thenReturn( multiPrinter );
        when( convertObjectToObjectDTOService.convertToEntityOrDTO( multiPrinter, MultiPrinterDTO.class ) )
                                                                                       .thenReturn( multiPrinterDTO );
        ...
        verify( multiPrinterRepository, times( 1 ) ).existsBySerialNumber( multiPrinterDTO.getSerialNumber() );
    ...
    void shouldSetImpressionCounter() {
        ...
        when( convertObjectToObjectDTOService.convertToEntityOrDTO( multiPrinter, MultiPrinterDTO.class ) )
                                                                                       .thenReturn( multiPrinterDTO );
        when( convertObjectToObjectDTOService.convertToEntityOrDTO( multiPrinterDTO, MultiPrinter.class ) ).thenReturn( multiPrinter );
